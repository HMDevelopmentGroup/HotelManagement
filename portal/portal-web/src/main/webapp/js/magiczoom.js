...
function MagicZoom(smallImageContId, smallImageId, bigImageContId, bigImageId, settings) {
	...
	// this.bigImage.src = $('#'+bigImageId).attr('src');
	//console.log(this.bigImage2);
	/*var img2 = $('#'+bigImageId).clone();
	img2.attr('src',"");
	img2.attr('src',$('#'+bigImageId).attr('src'));
	...
	*/
	...
	//console.log(this.bigImage.width);
...
MagicZoom.prototype.recalculatePopupDimensions = function() {
	//console.log(parseInt(this.bigImageCont.style.width));
    this.popupSizeX = (parseInt(this.bigImageCont.style.width) - 0) / (this.bigImageSizeX / this.smallImageSizeX);
	//console.log(this.popupSizeX)
	//console.log(this.bigImageSizeX)
